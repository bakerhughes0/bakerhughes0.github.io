...
(function() {
    ...
    function Va(h, l, v) {
        "millisecond" === v ? h.setMilliseconds(h.getMilliseconds() + 1 * l) : "second" === v ? h.setSeconds(h.getSeconds() + 1 * l) : "minute" === v ? h.setMinutes(h.getMinutes() + 1 * l) : "hour" === v ? h.setHours(h.getHours() + 1 * l) : "day" === v ? h.setDate(h.getDate() + 1 * l) : "week" === v ? h.setDate(h.getDate() + 7 * l) : "month" === v ? h.setMonth(h.getMonth() + 1 * l) : "year" === v && h.setFullYear(h.getFullYear() + 1 * l);
        return h
    }
    function Z(h, l) {
        var v = !1;
    ...
    function F(h, l, v, w, sa) {
        ...
        w.push([h, l, v, sa]);
        return h.addEventListener ? (h.addEventListener(l, v, sa),
        v) : h.attachEvent ? (w = function(l) {
            l = l || window.event;
    ...
    function gb(h) {
        if (h._menuButton)
            h.exportEnabled ? (U(h._menuButton, {
                backgroundColor: h.toolbar.itemBackgroundColor,
                color: h.toolbar.fontColor
            }),
            Ja(h._menuButton),
            pa(h, h._menuButton, "menu")) : ta(h._menuButton);
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            !h._dropdownMenu && (h.exportEnabled && w) && (l = !1,
            ...
            F(h._dropdownMenu, "blur", function() {
                ta(h._dropdownMenu);
            ...
            F(v, "mouseout", function() {
                l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor,
    ...
    function hb(h) {
        ...
        if (!ib) {
            var l = !1
              , v = !1;
            "undefined" === typeof na.Chart.creditHref ? (h.creditHref = ' ',
            h.creditText = ' ') : (l = ' ',
            v = ' ');
    ...
    function pa(h, l, v) {
        l.getAttribute("state") || (l.style.backgroundColor = h.toolbar.itemBackgroundColor,
    ...
    function Ra(h, l, v, s, w) {
        ...
        "undefined" !== typeof w && (h = Math.max(w, h)));
    ...
    function T(h, l, v, w, y) {
        ...
        h = {};
        this.theme && s(this.parent) && s(l) && s(w) ? h = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[l]) && (null === w ? h = this.parent.themeOptions[l] : 0 < this.parent.themeOptions[l].length && (w = Math.min(this.parent.themeOptions[l].length - 1, w),
    ...
    var Fa = !1, M = {}, w = !!document.createElement("canvas").getContext, na = {
        ...
        en: {}
    }, y = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Da = w ? "Impact, Charcoal, sans-serif" : "Arial", ya = {
    ...
    (function() {
        M.fSDec = function(h) {
            for (var l = "", v = 0; v < h.length; v++)
                l += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(v));
            return l
        }
        ;
    ...
    var fb = function() {
        ...
        try {
            ...
            window.addEventListener && (window.addEventListener("test", null, l),
      ...
      , da = function(h, l, v) {
        ...
        for (var J = 0; E && J < E.length; J++)
            ...
            "." === l && 0 > N)
                ...
                if ("%" === l)
                    ...
                    "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || (M = !0);
                0 > N ? (O.push(l),
                "#" === l || "0" === l ? Q++ : "," === l && S++) : (L.push(l),
                "#" !== l && "0" !== l || F++)
            }
        M && (l = Math.floor(h),
        ...
        for (M = E = J = F = N = 0; 0 < O.length; )
            ...
            "#" === l || "0" === l)
                ...
                "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (J++,
                E = M,
                M = 0,
                0 < x.length && (v = y + v)) : v = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > U ? l.replace("+", "").replace("-", "") : l.replace("-", ""),
        ...
        for (O = !1; 0 < L.length; )
            l = L.shift(),
            "#" === l || "0" === l ? 0 < h.length && 0 !== Number(h.join("")) ? (y += h.shift(),
            O = !0) : "0" === l && (y += "0",
            O = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? y += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? y += l : (l = 0 > U ? l.replace("+", "").replace("-", "") : l.replace("-", ""),
      ...
      , Ma = function(h) {
        var l = 0
          , v = 0;
        h = h || window.event;
        h.offsetX || 0 === h.offsetX ? (l = h.offsetX,
        v = h.offsetY) : h.layerX || 0 == h.layerX ? (l = h.layerX,
        v = h.layerY) : (l = h.pageX - h.target.offsetLeft,
      ...
      , bb = window && window[ha("mnb`uhno")] && window[ha("mnb`uhno")].href && window[ha("mnb`uhno")].href.indexOf && (-1 !== window[ha("mnb`uhno")].href.indexOf(ha("b`ow`rkr/bnl")) || -1 !== window[ha("mnb`uhno")].href.indexOf(ha("gdonqhy/bnl")) || -1 !== window[ha("mnb`uhno")].href.indexOf(ha("gheemd")))
    ...
    T.prototype.setOptions = function(h, l) {
        if (na[this._defaultsKey]) {
            ...
            for (w in s)
                "publicProperties" !== w && s.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : l && w in l ? l[w] : s[w])
        } else
            Fa && window.console && console.log("defaults not set")
    }
    ;
    ...
    T.prototype.addTo = function(h, l, s, w) {
        ...
        h.splice(s, 0, l),
        w && (this.stockChart || this.chart || this).render()) : window.console && (y.publicProperties && y.publicProperties.hasOwnProperty(h) && "readOnly" === y.publicProperties[h] ? window.console.log('Property "' + h + '" is read-only.') : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."))
    }
    ;
        ...
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            ...
            this.isOptionsInArray) {
                ...
                var l = this.parent.options[this.optionsName]
                  , s = l.length;
                this.options._isPlaceholder || (Ba(l),
    ...
    T.prototype.updateOption = function(h) {
        ...
        var l = na[this._defaultsKey]
          ...
          , F = this._index;
        this.theme && s(this.parent) && s(E) && s(F) ? w = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[E]) && (null === F ? w = this.parent.themeOptions[E] : 0 < this.parent.themeOptions[E].length && (w = Math.min(this.parent.themeOptions[E].length - 1, F),
        ...
        if (0 !== this.fontSize) {
            ...
            for (s = 0; s < this._wrappedText.lines.length; s++) {
                ...
                if ("right" === this.horizontalAlign || "right" === this.textAlign)
                    ...
                    w = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding;
    ...
    ia.prototype._getLineWithWidth = function(h, l, s) {
        ...
        s > l && 1 < x.length && (x = x.substr(0, x.length - 1),
        s = this.ctx.measureText(x).width);
        l = !0;
        if (x.length === h.length || " " === h[x.length])
            l = !1;
        l && (h = x.split(" "),
        1 < h.length && h.pop(),
        x = h.join(" "),
    ...
    xa.prototype.setLayout = function() {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, l = h.layoutManager.getFreeSpace(), w = l.x1, y = l.y1, E = 0, F = 0, x = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, M;
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = l.width - 4 - x * ("center" === this.horizontalAlign ? 2 : 1)),
            ...
            F = 0.5 * l.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = l.width - 4),
            F = 0.5 * l.height - 4));
            var O;
            s(this.padding) || "number" !== typeof this.padding ? s(this.padding) || "object" !== typeof this.padding || (O = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0,
            ...
            O = F.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (y = l.y1 + 2,
            M = "top") : "bottom" === this.verticalAlign && (y = l.y2 - 2 - O.height,
            M = "bottom"),
            ...
            this.width = O.width,
            this.height = O.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (w = l.x1 + 2,
            y = l.y2 - 2 - (this.maxWidth / 2 - O.width / 2),
            E = -90,
            M = "left",
            this.width = O.height,
            this.height = O.width) : "right" === this.horizontalAlign ? (w = l.x2 - 2,
            y = l.y1 + 2 + (this.maxWidth / 2 - O.width / 2),
            E = 90,
            M = "right",
            this.width = O.height,
            this.height = O.width) : "center" === this.horizontalAlign && (y = h.y1 + (h.height / 2 - O.height / 2),
    ...
    var Na = {
        ...
        formatNumber: function(h, l, s) {
            s = s || "en";
            if (Ia[s])
                return da(h, l || "#,##0.##", new Ha(s));
            throw "Unknown Culture Name";
        },
        formatDate: function(h, l, s) {
            s = s || "en";
            if (Ia[s])
                return za(h, l || "DD MMM YYYY", new Ha(s));
            throw "Unknown Culture Name";
        }
    };
    ...
    y = Na.Chart = function() {
        ...
        function l(a, d, c) {
            ...
            w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ra(a, d),
            ...
            this.windowResizeHandler = F(window, "resize", function() {
        ...
        function y(a, d, c, b, e, f, m, u, C, k) {
            ...
            a.beginPath();
            C && 0 < u.thickness ? (a.moveTo(b - m.thickness / 2, Math.round((c + e) / 2) - p),
            a.lineTo(d + m.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < u.thickness && (a.moveTo(Math.round((d + b) / 2) - p, c + m.thickness / 2),
            ...
            a.beginPath();
            C && 0 < m.thickness ? (a.moveTo(b - n, c),
            a.lineTo(b - n, e),
            a.moveTo(d + n, c),
            a.lineTo(d + n, e)) : 0 < m.thickness && (a.moveTo(d, c + n),
            a.lineTo(b, c + n),
            a.moveTo(d, e - n),
            a.lineTo(b, e - n));
            a.stroke();
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton)
                    ...
                    F(this._zoomButton, "click", function() {
                        ...
                        a.panEnabled = !0,
                        pa(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0,
                        a.panEnabled = !1,
                ...
                F(this._resetButton, "mousemove", function() {
                    d || (U(a._resetButton, {
                        backgroundColor: a.toolbar.itemBackgroundColorOnHover,
                        color: a.toolbar.fontColorOnHover,
                        transition: "0.4s",
                ...
                F(this._resetButton, "mouseout", function() {
                    d || (U(a._resetButton, {
                        backgroundColor: a.toolbar.itemBackgroundColor,
                        color: a.toolbar.fontColor,
                        transition: "0.4s",
                ...
                this.panEnabled = !1),
                Ja(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0,
                this.panEnabled = !1))
            } else
        ...
        l.prototype.setLayout = function() {
                        ...
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var c = 0; c < this.options.axisY.length; c++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new x(this,"axisY",this.options.axisY[c],c,"axisY","left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new x(this,"axisY",this.options.axisY[c],c,"axisY","bottom"));
                            ...
                            this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new x(this,"axisY",this.options.axisY,0,"axisY","left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new x(this,"axisY",this.options.axisY,0,"axisY","bottom"))),
                        ...
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (c = 0; c < this.options.axisY2.length; c++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new x(this,"axisY2",this.options.axisY2[c],c,"axisY","right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new x(this,"axisY2",this.options.axisY2[c],c,"axisY","top"));
                            ...
                            this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new x(this,"axisY2",this.options.axisY2,0,"axisY","right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new x(this,"axisY2",this.options.axisY2,0,"axisY","top"))),
                        ...
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (c = 0; c < this.options.axisX.length; c++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new x(this,"axisX",this.options.axisX[c],c,"axisX","bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[c] = new x(this,"axisX",this.options.axisX[c],c,"axisX","left"));
                            ...
                            this.axisX.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[0] = new x(this,"axisX",this.options.axisX,0,"axisX","bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new x(this,"axisX",this.options.axisX,0,"axisX","left"))),
                        ...
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (c = 0; c < this.options.axisX2.length; c++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new x(this,"axisX2",this.options.axisX2[c],c,"axisX","top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new x(this,"axisX2",this.options.axisX2[c],c,"axisX","right"));
                            ...
                            this.axisX2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[0] = new x(this,"axisX2",this.options.axisX2,0,"axisX","top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[0] = new x(this,"axisX2",this.options.axisX2,0,"axisX","right"))),
            ...
            c ? (Ja(this._zoomButton, this._resetButton),
            this._toolBar.style.border = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor,
            this._zoomButton.style.borderRight = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor,
            this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor) : (ta(this._zoomButton, this._resetButton),
            ...
            eb(this);
            this._processData();
            this.options.title && (this.title = new xa(this,this.options.title),
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    w ? (this._breaksCanvas = ra(this.width, this.height, !0),
        ...
        l.prototype.renderElements = function() {
            ...
            if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)
                x.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement);
            ...
            w && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height),
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], m = 0; m < f.plotUnits.length; m++) {
                    ...
                    u.targetCanvas = null;
                    this.animatedRender && (u.targetCanvas = ra(this.width, this.height),
                    u.targetCanvasCtx = u.targetCanvas.getContext("2d"),
                    e = u.targetCanvasCtx.miterLimit,
                    u.targetCanvasCtx.miterLimit = 3);
                    "line" === u.type ? C = this.renderLine(u) : "stepLine" === u.type ? C = this.renderStepLine(u) : "spline" === u.type ? C = this.renderSpline(u) : "column" === u.type ? C = this.renderColumn(u) : "bar" === u.type ? C = this.renderBar(u) : "area" === u.type ? C = this.renderArea(u) : "stepArea" === u.type ? C = this.renderStepArea(u) : "splineArea" === u.type ? C = this.renderSplineArea(u) : "stackedColumn" === u.type ? C = this.renderStackedColumn(u) : "stackedColumn100" === u.type ? C = this.renderStackedColumn100(u) : "stackedBar" === u.type ? C = this.renderStackedBar(u) : "stackedBar100" === u.type ? C = this.renderStackedBar100(u) : "stackedArea" === u.type ? C = this.renderStackedArea(u) : "stackedArea100" === u.type ? C = this.renderStackedArea100(u) : "bubble" === u.type ? C = C = this.renderBubble(u) : "scatter" === u.type ? C = this.renderScatter(u) : "pie" === u.type ? this.renderPie(u) : "doughnut" === u.type ? this.renderPie(u) : "funnel" === u.type ? C = this.renderFunnel(u) : "pyramid" === u.type ? C = this.renderFunnel(u) : "candlestick" === u.type ? C = this.renderCandlestick(u) : "ohlc" === u.type ? C = this.renderCandlestick(u) : "rangeColumn" === u.type ? C = this.renderRangeColumn(u) : "error" === u.type ? C = this.renderError(u) : "rangeBar" === u.type ? C = this.renderRangeBar(u) : "rangeArea" === u.type ? C = this.renderRangeArea(u) : "rangeSplineArea" === u.type ? C = this.renderRangeSplineArea(u) : "waterfall" === u.type ? C = this.renderWaterfall(u) : "boxAndWhisker" === u.type && (C = this.renderBoxAndWhisker(u));
                    for (var k = 0; k < u.dataSeriesIndexes.length; k++)
                        this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[k]]);
                    this.animatedRender && (u.targetCanvasCtx.miterLimit = e,
                    C && c.push(C))
                }
        ...
        l.prototype._processMultiseriesPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var u = this.data[a.dataSeriesIndexes[m]], C = 0, k = !1, n = !1, p;
                    if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement)
                        var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity
                    ...
                    if (u.dataPoints[C].x && u.dataPoints[C].x.getTime || "dateTime" === u.xValueType)
                        f = !0;
                    for (C = 0; C < u.dataPoints.length; C++) {
                        "undefined" === typeof u.dataPoints[C].x && (u.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0));
                        u.dataPoints[C].x.getTime ? (f = !0,
                        b = u.dataPoints[C].x.getTime()) : b = u.dataPoints[C].x;
                        e = u.dataPoints[C].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < C) {
                            ...
                            null !== e && null !== u.dataPoints[C - 1].y && (a.axisY.logarithmic ? (r = e / u.dataPoints[C - 1].y,
                            1 > r && (r = 1 / r),
                            d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e - u.dataPoints[C - 1].y,
                            0 > r && (r *= -1),
                        ...
                        if (b < q && !k)
                            ...
                            null === e ? c.viewPortMin === b && p < b && (c.viewPortMin = p) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e),
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = [], u = [], C = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
                        var nb = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        p.dataPoints[q].x.getTime ? (f = !0,
                        b = p.dataPoints[q].x.getTime()) : b = p.dataPoints[q].x;
                        ...
                        if (0 < q) {
                            ...
                            null !== e && null !== p.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (l = e / p.dataPoints[q - 1].y,
                            1 > l && (l = 1 / l),
                            d.minDiff > l && 1 !== l && (d.minDiff = l)) : (l = e - p.dataPoints[q - 1].y,
                            0 > l && (l *= -1),
                        ...
                        if (b < nb && !g)
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                            a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e),
                            0 <= e ? m[b] ? m[b] += e : (m[b] = e,
                            C = Math.min(e, C)) : u[b] ? u[b] += e : (u[b] = e,
                            k = Math.max(e, k)))
                        }
                    }
                    ...
                    d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, u)) : (d.dataPointYPositiveSums = m,
                    d.dataPointYNegativeSums = u));
                    p.axisX.valueType = p.xValueType = f ? "dateTime" : "number"
                }
                for (q in m)
                    m.hasOwnProperty(q) && !isNaN(q) && (a = m[q],
                    a < d.min && (d.min = Math.min(a, C)),
                    a > d.max && (d.max = a),
                    q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, C)),
                    a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in u)
                    u.hasOwnProperty(q) && !isNaN(q) && (a = u[q],
                    a < d.min && (d.min = a),
                    a > d.max && (d.max = Math.max(a, k)),
                    q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a),
        ...
        l.prototype._processStacked100PlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = !1, u = !1, C = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var n = this.data[a.dataSeriesIndexes[k]], p = 0, q = !1, g = !1, r;
                    ...
                    for (p = 0; p < n.dataPoints.length; p++) {
                        ...
                        n.dataPoints[p].x.getTime ? (f = !0,
                        b = n.dataPoints[p].x.getTime()) : b = n.dataPoints[p].x;
                        ...
                        if (0 < p) {
                            ...
                            s(e) || null === n.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (t = e / n.dataPoints[p - 1].y,
                            1 > t && (t = 1 / t),
                            d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - n.dataPoints[p - 1].y,
                            0 > t && (t *= -1),
                        ...
                        if (b < h && !q)
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && r < b && (c.viewPortMin = r) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                            a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e),
                            0 <= e ? m = !0 : 0 > e && (u = !0),
                ...
                d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : m && !u ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : m && u ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !m && u && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1),
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, m, u = !1, C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    for (n = 0; n < k.dataPoints.length; n++) {
                        ...
                        k.dataPoints[n].x.getTime ? (u = !0,
                        b = k.dataPoints[n].x.getTime()) : b = k.dataPoints[n].x;
                        ...
                        f < d.min && (d.min = f);
                        m > d.max && (d.max = m);
                        0 < n && (a.axisX.logarithmic ? (r = b / k.dataPoints[n - 1].x,
                        1 > r && (r = 1 / r),
                        c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - k.dataPoints[n - 1].x,
                        0 > r && (r *= -1),
                        c.minDiff > r && 0 !== r && (c.minDiff = r)),
                        e && (null !== e[0] && k.dataPoints[n - 1].y && null !== k.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[n - 1].y[0],
                        1 > r && (r = 1 / r),
                        d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[n - 1].y[0],
                        0 > r && (r *= -1),
                        d.minDiff > r && 0 !== r && (d.minDiff = r))));
                        if (!(b < l) || p) {
                            if (!p && (p = !0,
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (u.dataPoints[C].x && u.dataPoints[C].x.getTime || "dateTime" === u.xValueType)
                        f = !0;
                    for (C = 0; C < u.dataPoints.length; C++)
                        "undefined" !== typeof u.dataPoints[C].isCumulativeSum && !0 === u.dataPoints[C].isCumulativeSum ? (u.dataPointEOs[C].cumulativeSumYStartValue = 0,
                        u.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum,
                        u.dataPoints[C].y = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum) : "undefined" !== typeof u.dataPoints[C].isIntermediateSum && !0 === u.dataPoints[C].isIntermediateSum ? (u.dataPointEOs[C].cumulativeSumYStartValue = p,
                        u.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum,
                        u.dataPoints[C].y = 0 === C ? 0 : b,
                        p = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum,
                        b = 0) : (e = "number" !== typeof u.dataPoints[C].y ? 0 : u.dataPoints[C].y,
                        ...
                        b += e);
                    for (C = 0; C < u.dataPoints.length; C++)
                        if ("undefined" === typeof u.dataPoints[C].x && (u.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0)),
                        u.dataPoints[C].x.getTime ? (f = !0,
                        b = u.dataPoints[C].x.getTime()) : b = u.dataPoints[C].x,
                        e = u.dataPoints[C].y,
                        b < c.min && (c.min = b),
                        ...
                        0 < C && (a.axisX.logarithmic ? (p = b / u.dataPoints[C - 1].x,
                        1 > p && (p = 1 / p),
                        c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - u.dataPoints[C - 1].x,
                        0 > p && (p *= -1),
                        c.minDiff > p && 0 !== p && (c.minDiff = p)),
                        null !== e && null !== u.dataPoints[C - 1].y && (a.axisY.logarithmic ? (e = u.dataPointEOs[C].cumulativeSum / u.dataPointEOs[C - 1].cumulativeSum,
                        1 > e && (e = 1 / e),
                        d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = u.dataPointEOs[C].cumulativeSum - u.dataPointEOs[C - 1].cumulativeSum,
                        0 > e && (e *= -1),
                        ...
                        !(b < q) || k) {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < C && (u.dataPointEOs[C - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[C - 1].cumulativeSum),
        ...
        l.prototype.calculateAutoBreaks = function() {
                        ...
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, m = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, u = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
                            ...
                            if (!(4 > h.dataPoints.length))
                                for (u = 0; u < h.dataPoints.length; u++)
                                    if (b && (q = (k + 1 - m) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
            ...
            for (var b, e = this, f = !1, m = 0; m < this._axes.length; m++)
                if (this._axes[m].scaleBreaks && this._axes[m].scaleBreaks.autoCalculate && 1 <= this._axes[m].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var u = 0; u < 100 / Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) || 10, 10); u++)
            ...
            if (f) {
                for (m = 0; m < this.plotInfo.plotTypes.length; m++)
                    for (f = this.plotInfo.plotTypes[m],
                    u = 0; u < f.plotUnits.length; u++)
                        b = f.plotUnits[u],
                ...
                for (m = 0; m < this._axes.length; m++)
                    if (this._axes[m].dataInfo._dataRanges) {
                        ...
                        if (this._axes[m].dataInfo.dataPointYPositiveSums) {
                            ...
                            n = k;
                            for (u in q)
                                if (q.hasOwnProperty(u) && !isNaN(u) && (p = q[u],
                                !s(p))) {
                        ...
                        if (this._axes[m].dataInfo.dataPointYNegativeSums) {
                            ...
                            n = k;
                            for (u in q)
                                q.hasOwnProperty(u) && !isNaN(u) && (p = -1 * q[u],
                                s(p) || (g = Math.floor((p - C) / b),
                                p < n[g].min && (n[g].min = p),
                                p > n[g].max && (n[g].max = p)));
                        ...
                        if (this._axes[m].scaleBreaks.customBreaks)
                            for (u = 0; u < this._axes[m].scaleBreaks.customBreaks.length; u++)
                                for (b = 0; b < f.length; b++)
                                    if (this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].endValue || this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].endValue || f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].startValue && this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].end || f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].endValue && this._axes[m].scaleBreaks.customBreaks[u].endValue <= f[b].end)
                                        f.splice(b, 1),
                                        b--;
                        f.sort(function(a, b) {
        ...
        l.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            for (c = 0; c < b.length; c++)
                if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type)
                    if (e = ka("markerSize", b[c].dataPoint, b[c].dataSeries) || 8,
                    b[c].distance <= e / 2) {
                        d = !0;
                        break
                    }
            ...
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(c && 1 < c.length)) {
                    ...
                    try {
                        ...
                        if (1 < Math.abs(m) && this._lastTouchData.scroll || 5 < Math.abs(m) && 250 > f)
        ...
        l.prototype._mouseEventHandler = function(a) {
            ...
            if (this.interactivityEnabled)
                ...
                Fa && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y),
                ...
                !e) {
                    ...
                    if (d.x < c.x1 || d.x > c.x2 || d.y < c.y1 || d.y > c.y2) {
                        ...
                        for (f = 0; f < this.axisX.length; f++)
                            this.axisX[f].crosshair && this.axisX[f].crosshair.enabled && (this.axisX[f].crosshair.hide(),
                            this.axisX[f].crosshair.dispatchEvent("hidden", {
                                chart: this,
                                axis: this.axisX[f].options
                            }, this.axisX[f].crosshair));
                        for (f = 0; f < this.axisX2.length; f++)
                            this.axisX2[f].crosshair && this.axisX2[f].crosshair.enabled && (this.axisX2[f].crosshair.hide(),
                            this.axisX2[f].crosshair.dispatchEvent("hidden", {
                                chart: this,
                        ...
                        for (f = 0; f < this.axisY2.length; f++)
                            this.axisY2[f].crosshair && this.axisY2[f].crosshair.enabled && (this.axisY2[f].crosshair.hide(),
                            this.axisY2[f].crosshair.dispatchEvent("hidden", {
                                chart: this,
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    if (this.panEnabled)
                        for (e = f = 0; e < this._axes.length; e++)
                            ...
                            m = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum / c.maximum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum / f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum / f,
                            m = !0) : c.viewportMinimum < c.minimum ? (f = c.minimum - c.viewportMinimum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum + f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum + f,
                            m = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum - c.maximum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum - f,
                    ...
                    m && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (Ja(this._zoomButton, this._resetButton),
                    pa(this, this._zoomButton, "pan"),
                    pa(this, this._resetButton, "reset")))
                }
            }
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (var u = 0; u < this.axisX.length; u++)
                        this.axisX[u].crosshair && this.axisX[u].crosshair.enabled && (this.axisX[u].crosshair.hide(),
                        this.axisX[u].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisX[u].options
                        }, this.axisX[u].crosshair));
                    for (u = 0; u < this.axisX2.length; u++)
                        this.axisX2[u].crosshair && this.axisX2[u].crosshair.enabled && (this.axisX2[u].crosshair.hide(),
                        this.axisX2[u].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisX2[u].options
                        }, this.axisX2[u].crosshair));
                    for (u = 0; u < this.axisY.length; u++)
                        this.axisY[u].crosshair && this.axisY[u].crosshair.enabled && (this.axisY[u].crosshair.hide(),
                        this.axisY[u].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisY[u].options
                        }, this.axisY[u].crosshair));
                    for (u = 0; u < this.axisY2.length; u++)
                        this.axisY2[u].crosshair && this.axisY2[u].crosshair.enabled && (this.axisY2[u].crosshair.hide(),
                        this.axisY2[u].crosshair.dispatchEvent("hidden", {
                            chart: this,
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        ...
                        m._panTimerId = setTimeout(function(b, c, e, f) {
                            return function() {
                                m._zoomPanToSelectedRegion(b, c, e, f, !0) && (m._dispatchRangeEvent("rangeChanging", "pan"),
                                m.stockChart && (m.stockChart.navigator && m.stockChart.navigator.enabled) && (m.stockChart._rangeEventParameter.type = "rangeChanging",
                                m.stockChart.dispatchEvent("rangeChanging", m.stockChart._rangeEventParameter, m.stockChart)),
                                m.render(),
                                m._dispatchRangeEvent("rangeChanged", "pan"),
                                m.stockChart && (m.stockChart.navigator && m.stockChart.navigator.enabled) && (m.stockChart._rangeEventParameter.type = "rangeChanged",
                                m.stockChart.dispatchEvent("rangeChanged", m.stockChart._rangeEventParameter, m.stockChart)),
        ...
        l.prototype.validateRegion = function(a, d, c, b, e) {
            ...
            for (m = 0; m < k.length; m++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (r = p.getApparentDifference(q, g, null, !0),
        ...
        l.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var n = this._indexLabels[a], p = n.chartType.toLowerCase(), q, g, m = ka("indexLabelFontColor", n.dataPoint, n.dataSeries), r = ka("indexLabelFontSize", n.dataPoint, n.dataSeries), u = ka("indexLabelFontFamily", n.dataPoint, n.dataSeries), C = ka("indexLabelFontStyle", n.dataPoint, n.dataSeries), k = ka("indexLabelFontWeight", n.dataPoint, n.dataSeries), h = ka("indexLabelBackgroundColor", n.dataPoint, n.dataSeries);
                ...
                if (null !== v && "" !== v) {
                    ...
                    if ("stackedarea100" === p) {
                        if (n.point.x < c.x1 || n.point.x > c.x2 || n.point.y < c.y1 - 1 || n.point.y > c.y2 + 1)
                            continue
                    } else if ("rangearea" === p || "rangesplinearea" === p) {
                        if (n.dataPoint.x < e.viewportMinimum || n.dataPoint.x > e.viewportMaximum || Math.max.apply(null, n.dataPoint.y) < f.viewportMinimum || Math.min.apply(null, n.dataPoint.y) > f.viewportMaximum)
                            continue
                    } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) {
                        if (n.dataPoint.x < e.viewportMinimum || n.dataPoint.x > e.viewportMaximum || n.dataPoint.y < f.viewportMinimum || n.dataPoint.y > f.viewportMaximum)
                            continue
                    } else if (0 <= p.indexOf("column") || "waterfall" === p || "error" === p && !n.axisSwapped) {
                        if (n.dataPoint.x < e.viewportMinimum || n.dataPoint.x > e.viewportMaximum || n.bounds.y1 > c.y2 || n.bounds.y2 < c.y1)
                            continue
                    } else if (0 <= p.indexOf("bar") || "error" === p) {
                        if (n.dataPoint.x < e.viewportMinimum || n.dataPoint.x > e.viewportMaximum || n.bounds.x1 > c.x2 || n.bounds.x2 < c.x1)
                            continue
                        ...
                        continue;
                    m = u = 2;
                    "horizontal" === A ? (C = h.width,
                    k = h.height) : (k = h.width,
                    C = h.height);
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== z ? (e = c.y1,
                        f = c.y2,
                        0 < y ? (g = n.point.y + ("horizontal" === A ? r / 2 : 0) - k - u - b,
                        g < e && (g = "auto" === z ? Math.max(n.point.y, e) + r / 2 + u : e + r / 2 + u,
                        x = g + k > n.point.y)) : (g = n.point.y + r / 2 + u + b,
                        g > f - k && (g = "auto" === z ? Math.min(n.point.y, f) + r / 2 - k - u : f + r / 2 - k,
                        x = g < n.point.y))) : (e = Math.max(n.bounds.y1, c.y1),
                        f = Math.min(n.bounds.y2, c.y2 - k + r / 2),
                        b = 0 <= p.indexOf("range") || "error" === p ? 0 < y ? Math.max(n.bounds.y1, c.y1) + r / 2 + u : Math.min(n.bounds.y2, c.y2) + r / 2 - k + u : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === A ? u : 0),
                        0 < y ? (g = Math.max(n.point.y, b),
                        g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(n.point.y - k - u, c.y1 + u))) : (g = Math.min(n.point.y, b),
                        g > f - k - u && ("bubble" === p || "scatter" === p) && (g = Math.min(n.point.y + u, c.y2 - k - u))),
                        g = Math.min(g, f))
                    } else
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (z = "auto",
                        m = 4) : 0 <= p.indexOf("stacked") ? "auto" === z && (z = "inside") : "bubble" === p && (z = "inside"),
                        g = n.point.y + r / 2 - k / 2 + u,
                        "inside" !== z ? (e = c.x1,
                        f = c.x2,
                        0 > y ? (q = n.point.x - ("horizontal" === A ? C : C - r / 2) - m - b,
                        q < e && (q = "auto" === z ? Math.max(n.point.x, e) + m : e + m,
                        x = q + C > n.point.x)) : (q = n.point.x + ("horizontal" === A ? 0 : r / 2) + m + b,
                        q > f - C - m - b && (q = "auto" === z ? Math.min(n.point.x, f) - ("horizontal" === A ? C : C / 2) - m : f - C - m,
                        x = q < n.point.x))) : (e = Math.max(n.bounds.x1, c.x1),
                        Math.min(n.bounds.x2, c.x2),
                        b = 0 <= p.indexOf("range") || "error" === p ? 0 > y ? Math.max(n.bounds.x1, c.x1) + r / 2 + m : Math.min(n.bounds.x2, c.x2) - C / 2 - m + ("horizontal" === A ? 0 : r / 2) : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === A ? 0 : r / 2),
                    ...
                    h.y = g;
                    h.render(!0);
                    B && ("inside" !== z && (0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2 || !x) && (0 > p.indexOf("column") && ("error" !== p || n.axisSwapped) && n.point.y > c.y1 && n.point.y < c.y2 || !x)) && (d.lineWidth = B,
                    d.strokeStyle = t ? t : "gray",
                    d.setLineDash && d.setLineDash(N(l, B)),
                    d.beginPath(),
                    d.moveTo(n.point.x, n.point.y),
                    0 <= p.indexOf("bar") || "error" === p && n.axisSwapped ? d.lineTo(q + (0 < n.direction ? -m : C + m) + ("vertical" === A ? -r / 2 : 0), g + ("vertical" === A ? -k / 2 : k / 2 - r / 2) - u) : 0 <= p.indexOf("column") || "error" === p && !n.axisSwapped ? d.lineTo(q + C / 2 - ("horizontal" === A ? 0 : r / 2), g + ("vertical" === A ? (g - k < n.point.y ? 0 : -k) + u : (g - r / 2 < n.point.y ? k : 0) - r / 2)) : d.lineTo(q + C / 2 - ("horizontal" === A ? 0 : r / 2), g + ("vertical" === A ? g - k < n.point.y ? 0 : -k : (g - r / 2 < n.point.y ? k : 0) - r / 2)),
                    d.stroke())
                }
            }
            d = {
            ...
            for (a = 0; a < this._indexLabels.length; a++)
                ...
                n.dataSeries.indexLabelBackgroundColor = s(h) ? w ? "transparent" : null : h;
            return d
        }
        ;
                ...
                for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < n.length) {
                        for (var A = !1, t = 0; t < n.length; t++)
                            if (s = n[t].x.getTime ? n[t].x.getTime() : n[t].x,
                            !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !A)))
                                if ("number" !== typeof n[t].y)
                                    0 < t && !(k.connectNullData || A || l) && (c.stroke(),
                                    w && b.stroke()),
                                    A = !0;
                                else {
                                    ...
                                    l || A ? (!l && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(m.x, m.y),
                                    p = k.nullDataLineDashType,
                                    c.setLineDash(q)),
                                    c.lineTo(s, z),
                                    w && b.lineTo(s, z)) : (c.beginPath(),
                                    c.moveTo(s, z),
                                    w && (b.beginPath(),
                                    b.moveTo(s, z))),
                                    A = l = !1) : (c.lineTo(s, z),
                                    ...
                                    h = n[t].lineColor || r,
                                    c.strokeStyle = h,
                                    c.setLineDash && (n[t].lineDashType ? (p = n[t].lineDashType,
                                    c.setLineDash(N(p, k.lineThickness))) : (p = k.lineDashType,
                                    c.setLineDash(g))));
        ...
        l.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < n.length) {
                        for (var A = !1, t = 0; t < n.length; t++)
                            if (s = n[t].getTime ? n[t].x.getTime() : n[t].x,
                            !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !A)))
                                if ("number" !== typeof n[t].y)
                                    0 < t && !(k.connectNullData || A || l) && (c.stroke(),
                                    w && b.stroke()),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < n.length)
                        for (s = !1,
                        l = 0; l < n.length; l++)
                            if (t = n[l].getTime ? n[l].x.getTime() : n[l].x,
                            !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !s)))
                                if ("number" !== typeof n[l].y)
                                    0 < l && !s && (k.connectNullData ? b.setLineDash && (0 < z.length && (k.options.nullDataLineDashType || !n[l - 1].lineDashType)) && (z[z.length - 1].newLineDashArray = q,
                                    p = k.nullDataLineDashType) : (d(z),
                                    z = [])),
                                    s = !0;
                                else {
                                    ...
                                    l < n.length - 1 && (h !== (n[l].lineColor || r) || p !== (n[l].lineDashType || k.lineDashType)) && (h = n[l].lineColor || r,
                                    z[z.length - 1].newStrokeStyle = h,
                                    b.setLineDash && (n[l].lineDashType ? (p = n[l].lineDashType,
                                    z[z.length - 1].newLineDashArray = N(p, k.lineThickness)) : (p = k.lineDashType,
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < r.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
                            if (r[f].getTime ? C = r[f].x.getTime() : C = r[f].x,
                            !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                        ...
                        for (k = 0; k < t.length; k++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y)
                                    u[b] = t[k].y + (u[b] ? u[b] : 0),
                                    0 < u[b] && (p = a.axisY.convertValueToPixel(u[b]),
                                    ...
                                    m[b] = A;
                                else if (p = a.axisY.convertValueToPixel(t[k].y),
                                0 <= t[k].y) {
                        ...
                        for (var s = 5 < r && l.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                0 <= t[k].y) {
                                    ...
                                    A = p + v,
                                    p = q + v,
                                    a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y2 - A) && (A = e.y2),
                                    m[b] = v + (A - p);
                                b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length];
                                ea(c, n, a.axisY.reversed ? A : p, z, a.axisY.reversed ? p : A, b, 0, null, s && (a.axisY.reversed ? 0 > t[k].y : 0 <= t[k].y), (a.axisY.reversed ? 0 <= t[k].y : 0 > t[k].y) && s, !1, !1, l.fillOpacity);
                                b = l.dataPointIds[k];
                    ...
                    if (0 < t.length) {
                        ...
                        for (k = 0; k < t.length; k++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                else if (n = a.axisY.convertValueToPixel(z),
                                0 <= t[k].y) {
                                    var v = f[b] ? f[b] : 0;
                                    z = q + v;
                                    n += v;
                                    ...
                                    z = n - v,
                                    n = q - v,
                                    a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - z) && (z = e.x1),
                                    m[b] = v + (n - z);
                                b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length];
        ...
        l.prototype.renderArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var m = this._eventManager.ghostCtx, u = a.axisY.lineCoordinates, C = [], k = this.plotArea, n;
                f.save();
                w && m.save();
                f.beginPath();
                ...
                f.clip();
                w && (m.beginPath(),
                m.rect(k.x1, k.y1, k.width, k.height),
                m.clip());
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    C = [];
                    d = !0;
                    var h = 0, l, t, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), A, v = null;
                    if (0 < r.length) {
                        ...
                        for (var ba = !0; h < r.length; h++)
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x,
                            !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ba)))
                                if ("number" !== typeof r[h].y)
                                    g.connectNullData || (ba || d) || b(),
                                    ba = !0;
                                else {
                                    l = a.axisX.convertValueToPixel(s);
                                    t = a.axisY.convertValueToPixel(r[h].y);
                                    d || ba ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = l,
                                    c = t,
                                    l = n.x,
                                    t = n.y,
                                    b(),
                                    ...
                                    h < r.length - 1 && (x !== (r[h].lineColor || y) || c !== (r[h].lineDashType || g.lineDashType)) && (b(),
                                    x = r[h].lineColor || y,
                                    f.strokeStyle = x,
                                    f.setLineDash && (r[h].lineDashType ? (c = r[h].lineDashType,
                                    f.setLineDash(N(c, g.lineThickness))) : (c = g.lineDashType,
                                    f.setLineDash(R))));
                                    ...
                                    0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, l, t, f),
                                    C.push(s),
                                    Y = Q(Y),
                                    w && C.push({
                                        x: l,
        ...
        l.prototype.renderSplineArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.clip();
                w && (e.beginPath(),
                e.rect(u.x1, u.y1, u.width, u.height),
                e.clip());
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    m = Q(m);
                    e.fillStyle = m;
                    var m = [], q = 0, g, r, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s, t = null, B = [];
                    if (0 < p.length) {
                        ...
                        for (r = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !r)))
                                if ("number" !== typeof p[q].y)
                                    0 < q && !r && (n.connectNullData ? b.setLineDash && (0 < B.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (B[B.length - 1].newLineDashArray = x,
                                    D = n.nullDataLineDashType) : (d(),
                                    B = [])),
                                    r = !0;
                                else {
                                    ...
                                    q < p.length - 1 && (y !== (p[q].lineColor || A) || D !== (p[q].lineDashType || n.lineDashType)) && (y = p[q].lineColor || A,
                                    B[B.length - 1].newStrokeStyle = y,
                                    b.setLineDash && (p[q].lineDashType ? (D = p[q].lineDashType,
                                    B[B.length - 1].newLineDashArray = N(D, n.lineThickness)) : (D = n.lineDashType,
        ...
        l.prototype.renderStepArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    h = [];
                    d = !0;
                    var l = 0, s, t, B, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v, y = null;
                    c = !1;
                    if (0 < r.length) {
                        ...
                        for (; l < r.length; l++)
                            if (B = r[l].x.getTime ? r[l].x.getTime() : r[l].x,
                            !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var Y = t;
                                "number" !== typeof r[l].y ? (g.connectNullData || (c || d) || b(),
                                c = !0) : (s = a.axisX.convertValueToPixel(B),
                                t = a.axisY.convertValueToPixel(r[l].y),
                                d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || I === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = s,
                                c = t,
                                s = n.x,
                                t = n.y,
                                b(),
                                ...
                                l < r.length - 1 && (E !== (r[l].lineColor || x) || I !== (r[l].lineDashType || g.lineDashType)) && (b(),
                                E = r[l].lineColor || x,
                                f.strokeStyle = E,
                                f.setLineDash && (r[l].lineDashType ? (I = r[l].lineDashType,
                                f.setLineDash(N(I, g.lineThickness))) : (I = g.lineDashType,
                                f.setLineDash(ba)))),
                                B = g.dataPointIds[l],
                                this._eventManager.objectMap[B] = {
                                    id: B,
                                ...
                                0 !== r[l].markerSize && (0 < r[l].markerSize || 0 < g.markerSize) && (Y = g.getMarkerProperties(l, s, t, f),
                                h.push(Y),
                                B = Q(B),
                                w && h.push({
                                    x: s,
        ...
        l.prototype.renderStackedArea = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, m = [], u = this.plotArea, h = [], k = [], n = [], p = [], q = 0, g, r, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, t, B, z;
                w && s.beginPath();
                b.save();
                w && s.save();
                b.beginPath();
                ...
                b.clip();
                w && (s.beginPath(),
                s.rect(u.x1, u.y1, u.width, u.height),
                s.clip());
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !Y)))
                                if ("number" !== typeof fa.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        r = a.axisY.convertValueToPixel(fa.y),
                                        r -= la;
                                    k.push({
                                        x: g,
                                        y: l - la
                                    ...
                                    h[f] = l - r;
                                    B || Y ? (!B && D.connectNullData ? (b.setLineDash && (D.options.nullDataLineDashType || z === D.lineDashType && D.lineDashType !== D.nullDataLineDashType) && (B = k.pop(),
                                    z = k[k.length - 1],
                                    d(),
                                    b.moveTo(t.x, t.y),
                                    k.push(z),
                                    ...
                                    q < x.length - 1 && (I !== (x[q].lineColor || E) || z !== (x[q].lineDashType || D.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(g, r),
                                    k.push({
                                        x: g,
                                    ...
                                    I = x[q].lineColor || E,
                                    b.strokeStyle = I,
                                    b.setLineDash && (x[q].lineDashType ? (z = x[q].lineDashType,
                                    b.setLineDash(N(z, D.lineThickness))) : (z = D.lineDashType,
                                    b.setLineDash(ba))));
                                    ...
                                    0 <= D.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < D.markerSize) && (la = D.getMarkerProperties(D.dataPointIndexes[f], g, r, b),
                                    m.push(la),
                                    f = Q(aa),
                                    w && m.push({
                                        x: g,
        ...
        l.prototype.renderStackedArea100 = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, m = this.plotArea, u = [], h = [], k = [], n = [], p = [], q = 0, g, r, l, s, t, B = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z = this._eventManager.ghostCtx;
                b.save();
                w && z.save();
                b.beginPath();
                ...
                b.clip();
                w && (z.beginPath(),
                z.rect(m.x1, m.y1, m.width, m.height),
                z.clip());
                for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var y = a.dataSeriesIndexes[v]
                      , D = this.data[y]
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !Y)))
                                if ("number" !== typeof fa.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        r = a.axisY.convertValueToPixel(la),
                                        r -= aa;
                                    k.push({
                                        x: g,
                                        y: B - aa
                                    ...
                                    h[f] = B - r;
                                    s || Y ? (!s && D.connectNullData ? (b.setLineDash && (D.options.nullDataLineDashType || t === D.lineDashType && D.lineDashType !== D.nullDataLineDashType) && (s = k.pop(),
                                    t = k[k.length - 1],
                                    d(),
                                    b.moveTo(l.x, l.y),
                                    k.push(t),
                                    ...
                                    q < x.length - 1 && (I !== (x[q].lineColor || E) || t !== (x[q].lineDashType || D.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(g, r),
                                    k.push({
                                        x: g,
                                    ...
                                    I = x[q].lineColor || E,
                                    b.strokeStyle = I,
                                    b.setLineDash && (x[q].lineDashType ? (t = x[q].lineDashType,
                                    b.setLineDash(N(t, D.lineThickness))) : (t = D.lineDashType,
                                    b.setLineDash(ba))));
                                    if (0 <= D.dataPointIndexes[f]) {
                                    ...
                                    0 <= D.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < D.markerSize) && (aa = D.getMarkerProperties(q, g, r, b),
                                    u.push(aa),
                                    f = Q(G),
                                    w && u.push({
                                        x: g,
                    ...
                    if (0 < n.length) {
                        ...
                        for (var p = 0, q = 0, e = 0; e < n.length; e++)
                            ...
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((p - f) * (p - f) + (q - m) * (q - m)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e],
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < B.length)
                        for (var z = 5 < r && t.bevelEnabled ? !0 : !1, u = 0; u < B.length; u++)
                            if (B[u].getTime ? g = B[u].x.getTime() : g = B[u].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(B[u].y) && B[u].y.length && "number" === typeof B[u].y[0] && "number" === typeof B[u].y[1] && "number" === typeof B[u].y[2] && "number" === typeof B[u].y[3]) {
                                ...
                                "candlestick" === t.type ? (c.moveTo(h - x, n),
                                ...
                                b.lineTo(h - x, p),
                                b.stroke(),
                                ea(b, A, Math.min(k, q), y, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (c.moveTo(h - x, n),
                                c.lineTo(h - x, p),
                                c.stroke(),
                                c.beginPath(),
                                c.moveTo(h, k),
        ...
        l.prototype.renderBoxAndWhisker = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              ...
              , b = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea, m = 0, u, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff;
                isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var l = !1, l = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < z.length)
                        for (var A = 5 < r && B.bevelEnabled ? !0 : !1, m = 0; m < z.length; m++)
                            if (z[m].getTime ? g = z[m].x.getTime() : g = z[m].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[m].y) && z[m].y.length && "number" === typeof z[m].y[0] && "number" === typeof z[m].y[1] && "number" === typeof z[m].y[2] && "number" === typeof z[m].y[3] && "number" === typeof z[m].y[4] && 5 === z[m].y.length) {
        ...
        l.prototype.renderRangeColumn = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, m, u, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < g.length)
                        for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x,
        ...
        l.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = !1, m = this.plotArea, u = 0, h, k, n, p, q, g, r, l = a.axisX.dataInfo.minDiff;
                ...
                for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var z = a.dataSeriesIndexes[B]
                      ...
                      , E = 0;
                    if (D)
                        for (e = A._linkedSeries.id,
                        t = 0; t < e; t++)
                            !this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && E || (this.data[t].type.match(/(range)/ig) && (f = !0),
                            E++);
                    ...
                    if (0 < x.length)
                        for (var F = A._colorSet, u = 0; u < x.length; u++) {
                            ...
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] && "number" === typeof x[u].y[1]) {
                                ...
                                b ? p = ba : g = ba;
                                b ? (q = a.axisX.reversed ? k + (D ? v : 1) * t / 2 - (D ? E - 1 : 0) * t << 0 : k - (D ? v : 1) * t / 2 + (D ? E - 1 : 0) * t << 0,
                                g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (n = a.axisX.reversed ? h + (D ? v : 1) * t / 2 - (D ? E - 1 : 0) * t << 0 : h - (D ? v : 1) * t / 2 + (D ? E - 1 : 0) * t << 0,
        ...
        l.prototype.renderRangeBar = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, m, u, h, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < r.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x,
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var I = !0; g < p.length; g++)
                            if (t = p[g].x.getTime ? p[g].x.getTime() : p[g].x,
                            !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !I)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || I ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || D === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E,
                                    ...
                                    g < p.length - 1 && (x !== (p[g].lineColor || A) || D !== (p[g].lineDashType || n.lineDashType)) && (d(),
                                    x = p[g].lineColor || A,
                                    h[h.length - 1].newStrokeStyle = x,
                                    b.strokeStyle = x,
                                    b.setLineDash && (p[g].lineDashType ? (D = p[g].lineDashType,
                                    h[h.length - 1].newLineDashArray = N(D, n.lineThickness),
                                    b.setLineDash(h[h.length - 1].newLineDashArray)) : (D = n.lineDashType,
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (g = !1; p < n.length; p++)
                            if (q = n[p].x.getTime ? n[p].x.getTime() : n[p].x,
                            !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                                    ...
                                    p < n.length - 1 && (z !== (n[p].lineColor || B) || A !== (n[p].lineDashType || k.lineDashType)) && (z = n[p].lineColor || B,
                                    s[s.length - 1].newStrokeStyle = z,
                                    b.setLineDash && (n[p].lineDashType ? (A = n[p].lineDashType,
                                    s[s.length - 1].newLineDashArray = N(A, k.lineThickness)) : (A = k.lineDashType,
                                    ...
                                    0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = D,
                                    A = k.nullDataLineDashType) : (d(y, B),
                                    s = [],
                                    x = [])),
                                    g = !0;
                        d(y, B);
        ...
        l.prototype.renderWaterfall = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, m = 0, h, l, k, n, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var z = 5 < q && s.bevelEnabled ? !0 : !1, x = !1, y = null, D = null, m = 0; m < v.length; m++)
                            if (v[m].getTime ? n = v[m].x.getTime() : n = v[m].x,
                            "number" !== typeof v[m].y) {
                                if (0 < m && !x && s.connectNullData)
                                    var E = s.options.nullDataLineDashType || !v[m - 1].lineDashType ? s.nullDataLineDashType : v[m - 1].lineDashType;
                                x = !0
                            } else {
                                ...
                                0 < m && y && (!x || s.connectNullData) && (x && c.setLineDash && c.setLineDash(N(E, t)),
                                c.beginPath(),
                                c.moveTo(y, D - B),
                                c.lineTo(I, R - B),
                                0 < t && c.stroke(),
        ...
        l.prototype.renderPie = function(a) {
            function d() {
                if (k && n) {
                    ...
                    for (e = 0; e < n.length; e++)
                        h = g[(c + e) % n.length],
                        1 < a && (h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !p ? (h.hemisphere = "right",
                        f++) : (h.hemisphere = "left",
                        p = !0));
                    p = !1;
                    for (e = 0; e < n.length; e++)
                        h = g[(d + e) % n.length],
                        1 < b && (h.midAngle > 3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t) && (m <= b / 2 && !p ? (h.hemisphere = "left",
                        m++) : (h.hemisphere = "right",
                        p = !0))
                }
            }
            function c(a) {
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * D * Math.cos(g[b].midAngle)
                          ...
                          , m = !1;
                        if (n[b].exploded) {
                            if (1E-9 < Math.abs(g[b].center.x - (z.x + e)) || 1E-9 < Math.abs(g[b].center.y - (z.y + f)))
                ...
                for (b = b = 0; b < n.length; b++)
                    ...
                    "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + D * Math.cos(c.midAngle),
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    q = e(a);
                    h = k = 0;
                    0 > c ? (h = "right" === p.hemisphere ? l : q,
                    m = c,
                    null !== h && (l = -c,
                    c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2),
                    c - l < r && (k = -l,
                    h = f(h, k, d + 1),
                    +h.toFixed(B) > +k.toFixed(B) && (m = c > r ? -(c - r) : -(l - (h - k)))))) : 0 < c && (h = "right" === p.hemisphere ? q : l,
                    m = c,
                    null !== h && (l = c,
                    c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2),
                    c - l < r && (k = l,
                    h = f(h, k, d + 1),
                    +h.toFixed(B) < +k.toFixed(B) && (m = c > r ? c - r : l - (k - h)))));
                    m && (d = p.indexLabelTextBlock.y + m,
                    c = 0,
                    c = "right" === p.hemisphere ? z.x + Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2)),
                    p.midAngle > Math.PI / 2 - t && p.midAngle < Math.PI / 2 + t ? (k = (a - 1 + g.length) % g.length,
                    k = g[k],
                    a = g[(a + 1 + g.length) % g.length],
                    "left" === p.hemisphere && "right" === k.hemisphere && c > k.indexLabelTextBlock.x ? c = k.indexLabelTextBlock.x - 15 : "right" === p.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : p.midAngle > 3 * Math.PI / 2 - t && p.midAngle < 3 * Math.PI / 2 + t && (k = (a - 1 + g.length) % g.length,
                    k = g[k],
                    a = g[(a + 1 + g.length) % g.length],
                    "right" === p.hemisphere && "left" === k.hemisphere && c < k.indexLabelTextBlock.x ? c = k.indexLabelTextBlock.x + 15 : "left" === p.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)),
            ...
            function m() {
                ...
                for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && D - d <= E)
                        m = !1;
                    m && (D -= d);
                    d = 0;
                            ...
                            if (null !== t) {
                                ...
                                if (0 > x) {
                                    for (var A = s = 0, y = 0; y < n.length; y++)
                                        y !== a && g[y].hemisphere === h.hemisphere && (g[y].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? s++ : A++);
                                    s = x / (s + A || 1) * A;
                                    var A = -1 * (x - s)
                                      , J = y = 0;
                                    "right" === h.hemisphere ? (y = f(a, s),
                                    A = -1 * (x - y),
                                    J = f(t, A),
                                    +J.toFixed(B) < +A.toFixed(B) && +y.toFixed(B) <= +s.toFixed(B) && f(a, -(A - J))) : (y = f(t, s),
                                    A = -1 * (x - y),
                                    J = f(a, A),
                                    +J.toFixed(B) < +A.toFixed(B) && +y.toFixed(B) <= +s.toFixed(B) && f(t, -(A - J)))
                                }
                            }
                        }
                    } else
                    ...
                    for (a = 0; a < n.length; a++)
                        ...
                        0 !== t.height && 0 !== t.width)
                            ...
                            0 < t && (!m && h.indexLabelText && (s = "right" === h.hemisphere ? q.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - q.x1,
                            ...
                            Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - z.y) < D || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - z.y) < D) && (t /= Math.abs(Math.cos(h.indexLabelAngle)),
                            9 < t && (t *= 0.3),
                            t > d && (d = t)),
                            t = t = 0,
                            0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (t = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5),
                            t *= -1) : t = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5),
                            0 < t && (!m && h.indexLabelText && (s = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1,
                            0 === f(a, t * s) && f(a, 2 * s)),
                            Math.abs(h.indexLabelTextBlock.x - z.x) < D && (t /= Math.abs(Math.sin(h.indexLabelAngle)),
                            9 < t && (t *= 0.3),
                            t > d && (d = t)));
                    var K = function(a, b, c) {
                        for (var d = [], e = 0; d.push(g[b]),
                        ...
                        for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < n.length; k++)
                            ...
                            u.indexLabelText) {
                                ...
                                if (null !== m) {
                                    ...
                                    m !== a && (c = m,
                                    d += -x),
                                    0 === k % Math.max(n.length / 10, 3) && (f = !0)) : f = !0;
            ...
            var l = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, r = 2, v, w = 1.3, t = 20 / 180 * Math.PI, B = 6, z = {
                    x: (q.x2 + q.x1) / 2,
                    y: (q.y2 + q.y1) / 2
                }, x = 0;
                a = !1;
                ...
                if (0 !== x) {
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        l.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
                        a.exploded = a.exploded ? !1 : !0,
                        1 < this.dataPoints.length && l._animator.animate(0, 500, function(a) {
                            c(a);
                            h();
        ...
        l.prototype.renderFunnel = function(a) {
            ...
            function c() {
                ...
                for (var m = d[0] = 0, h = 0, n, p, b = b - a, m = !1, k = 0; k < B.length; k++)
                    ...
                    m ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = X * X * b * b - 4 * Math.abs(X) * a,
                    0 > p ? (p = c,
                    m = (b + p) * (e - h) / 2,
                    a -= m,
                    n = e - h,
                    ...
                    n += 0 == p ? 0 : a / p,
                    h += a / p,
                    m = !0) : (n = (Math.abs(X) * b - Math.sqrt(p)) / 2,
                    p = b - 2 * n / Math.abs(X),
                    h += n,
                    h > e && (h -= n,
                    p = c,
            ...
            function b() {
                if (t && B) {
                    for (var a, b, c, d, e, f, k, m, h, n, p, q, l, u, r, C = [], v = [], z = {
                        percent: null,
                        total: null
                    }, y = null, A = 0; A < B.length; A++)
                        r = P[A],
                        r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2,
                        r = g(r).x2 + 1,
                        C[A] = L - r - S;
                    r = 0.5 * S;
                    for (var A = 0, D = B.length - 1; A < B.length || 0 <= D; A++,
                    D--) {
                        ...
                        "inside" === t.indexLabelPlacement && (C[A] = A !== ca ? t.reversed ? P[A].x2 - P[A].x1 : P[A].x3 - P[A].x4 : P[A].x3 - P[A].x6,
                        20 > C[A] && (C[A] = A !== ca ? t.reversed ? P[A].x3 - P[A].x4 : P[A].x2 - P[A].x1 : P[A].x2 - P[A].x1,
                        C[A] /= 2));
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(y) : b.indexLabel ? x.replaceKeywordsWithValue(b.indexLabel, b, t, A) : t.indexLabelFormatter ? t.indexLabelFormatter(y) : t.indexLabel ? x.replaceKeywordsWithValue(t.indexLabel, b, t, A) : b.label ? b.label : "";
                        0 >= n && (n = 0);
            ...
            function e() {
                ...
                if (e)
                    for (m = H.length - 1; 0 <= m; m--)
                        ...
                        t.reversed ? (H[m].textBlock.y + H[m].height > V + A && (H[m].textBlock.y = V + A - H[m].height),
                        H[m].textBlock.y < qa - A && (H[m].textBlock.y = qa - A)) : (H[m].textBlock.y < V - A && (H[m].textBlock.y = V - A),
                        H[m].textBlock.y + H[m].height > qa + A && (H[m].textBlock.y = qa + A - H[m].height))
            }
            function f() {
                var a, b, c, d;
                if ("inside" !== t.indexLabelPlacement)
                    for (var e = 0; e < P.length; e++)
                        0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = P[e],
                        c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                        b = t.reversed ? "undefined" !== typeof a.x5 ? c > va ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < va ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                        H[e].textBlock.x = b + S,
                        H[e].textBlock.y = c - H[e].height / 2,
                        t.reversed ? (H[e].textBlock.y + H[e].height > V + A && (H[e].textBlock.y = V + A - H[e].height),
                        H[e].textBlock.y < qa - A && (H[e].textBlock.y = qa - A)) : (H[e].textBlock.y < V - A && (H[e].textBlock.y = V - A),
                        H[e].textBlock.y + H[e].height > qa + A && (H[e].textBlock.y = qa + A - H[e].height)));
                else
                    for (e = 0; e < P.length; e++)
                        ...
                        c = H[e].height,
                        d = H[e].width,
                        b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2,
            ...
            function m() {
                ...
                function b() {
                    ...
                    for (var k, h = 1; h < m; h++) {
                        ...
                        for (var l = H.length - 1; 0 <= l; l--)
                            !H[l].isDirty && (H[l].textBlock.y < e && H[l].textBlock.y + H[l].height > e) && (k = q(l),
                            !(k >= H.length - 1) && H[l].textBlock.y + H[l].height + da > H[k].textBlock.y && (H[l].textBlock.y = H[l].textBlock.y + H[l].height - e > e - H[l].textBlock.y ? e + 1 : e - H[l].height - 1))
                    }
                ...
                for (var d, e, f, g, m, k, n = 1, l = 0; l < 2 * n; l++) {
                    for (var r = H.length - 1; 0 <= r && !(0 <= p(r) && p(r),
                    f = H[r],
                    g = f.textBlock,
                    k = (m = q(r) < P.length ? H[q(r)] : null) ? m.textBlock : null,
                    d = +f.height.toFixed(6),
                    e = +g.y.toFixed(6),
                    !f.isDirty && (m && e + d + da > +k.y.toFixed(6)) && (d = g.y + d + da - k.y,
                    e = a(r, -d),
                    e < d && (0 < e && (d -= e),
                    e = a(q(r), d),
                    e != d))); r--)
            ...
            function l(a, b, c) {
                ...
                a._animator.animate(0, c, function(c) {
                    ...
                    for (e = 0; e < P.length; e++)
                        na(d, P[e], t.fillOpacity);
                    v(d);
                    I && ("inside" !== t.indexLabelPlacement ? n(d) : f(),
                    r(d));
                    1 <= c && (ga = !1)
            ...
            function n(a) {
                for (var b, c, d, e, f = 0; f < P.length; f++)
                    ...
                    a.setLineDash && a.setLineDash(N(H[f].lineDashType, H[f].lineThickness)),
                    a.beginPath(),
                    a.moveTo(b, c),
                    a.lineTo(d, e),
                    a.stroke())
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var t = this.data[a.dataSeriesIndexes[0]], B = t.dataPoints, z = this.plotArea, A = 0.025 * z.width, y = 0.01 * z.width, D = 0, E = z.height - 2 * A, F = Math.min(z.width - 2 * y, 2.8 * z.height), I = !1, R = 0; R < B.length; R++)
                    if (!I && ("undefined" !== typeof B[R].indexLabel && null !== B[R].indexLabel && 0 < B[R].indexLabel.toString().length) && (I = !0),
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== B.length) {
                    ...
                    a = 75 * F / 100;
                    var S = 30 * (L - a) / 100;
                    "funnel" === t.type ? (aa = s(t.options.neckHeight) ? 0.35 * E : t.neckHeight,
                    G = s(t.options.neckWidth) ? 0.25 * a : t.neckWidth,
                    "string" === typeof aa && aa.match(/%$/) ? (aa = parseInt(aa),
                    aa = aa * E / 100) : aa = parseInt(aa),
                    "string" === typeof G && G.match(/%$/) ? (G = parseInt(G),
                    G = G * a / 100) : G = parseInt(G),
                    aa > E ? aa = E : 0 >= aa && (aa = 0),
                    G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === t.type && (G = aa = 0,
                    ...
                    var y = R + a / 2
                      ...
                      , qa = t.reversed ? Y : O;
                    a = [];
                    var y = [], P = [], F = [], T = Y, ca, X = (va - V) / (K - U), ea = -X, R = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d();
                    if (-1 !== R) {
                        if (t.reversed)
                            for (F.push(T),
                            G = R.length - 1; 0 < G; G--)
                        ...
                        if (t.reversed)
                            for (G = 0; G < R.length; G++)
                                F[G] < va ? (a.push(K),
                                y.push($),
                                ca = G) : (a.push((F[G] - V + X * U) / X),
                                y.push((F[G] - V + ea * Z) / ea));
                        else
                            for (G = 0; G < R.length; G++)
                                F[G] < va ? (a.push((F[G] - V + X * U) / X),
                                y.push((F[G] - V + ea * Z) / ea),
                                ca = G) : (a.push(K),
                                y.push($));
                        ...
                        for (G = 0; G < B.length; G++)
                            B[G].exploded && (R = !0,
                            t.reversed ? W.push(B.length - 1 - G) : W.push(G));
                        ...
                        "inside" !== t.indexLabelPlacement)) {
                            m();
                            for (G = 0; G < B.length; G++)
                                H[G].isDirty || (a = H[G].textBlock.x + H[G].width,
                                a = (L - a) / 2,
                                0 == G && (D = a),
                                D > a && (D = a));
                        ...
                        for (G = 0; G < P.length; G++)
                            D = P[G],
                            na(Q, D, t.fillOpacity),
                            ha.push(D.y1);
                        v(Q);
                        I && t.visible && ("inside" === t.indexLabelPlacement || x.animationEnabled || n(Q),
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ga && !x.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = t.reversed ? B.length - 1 - a.dataPointIndex : a.dataPointIndex,
                            0 <= b)) {
                                a = b;
                                if ("funnel" === t.type || "pyramid" === t.type)
                                    t.reversed ? B[B.length - 1 - a].exploded = B[B.length - 1 - a].exploded ? !1 : !0 : B[a].exploded = B[a].exploded ? !1 : !0;
                                l(x, b, 500)
                            }
                        }
                        ;
        ...
        l.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var m = b.replace(/^data:[a-z\/]*;base64,/, ""), m = atob(m), h = new ArrayBuffer(m.length), h = new Uint8Array(h), l = 0; l < m.length; l++)
                        h[l] = m.charCodeAt(l);
                    d = new Blob([h.buffer],{
                        type: "image/" + d
                    });
        ...
        l.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try {
                    var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    g && 0 < g.length && (m = Ea(g[2]),
                    a = Ea(g[1]))
                } catch (k) {}
                g = null;
                if ("color" === a)
                    return "waterfall" === c.type ? d.color ? d.color : 0 < d.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[m % c._colorSet.length] : d.color ? d.color : c.color ? c.color : c._colorSet[b % c._colorSet.length];
                ...
                if ("x" === a)
                    if (c.axisX && "dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
                        if (!c.axisX.logarithmic)
                            return za(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo)
                    } else
                        return da(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo);
                else
                    return "y" === a ? da(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? da(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
            })
        }
        ;
        ma(E, T);
            ...
            for (var n = 0; n < this.dataSeries.length; n++) {
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : L.getDefaultLegendMarker(p._linkedSeries.type) : L.getDefaultLegendMarker(p.type) : p.markerType
                ...
                for (n = 0; n < l.length; n++) {
                    ...
                    if (!(0 >= m || "undefined" === typeof m || 0 >= w || "undefined" === typeof w)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!p || p.width + Math.round(q.textBlock.width + v + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
                                p = {
                                    items: [],
                                    width: 0
                                },
                            ...
                            q.textBlock.measureText(),
                            null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (v + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                            this.height < m - this.lineHeight ? (p = {
                                items: [],
                                width: 0
                            },
                            k.push(p)) : (p = k[x],
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        ...
                        case "doughnut":
                            ...
                            r < q.radius && r > v && (r = Math.atan2(d - s.y, a - s.x),
                            0 > r && (r += 2 * Math.PI),
                        ...
                        case "pyramid":
                            r = q.funnelSection;
                            d > r.y1 && d < r.y4 && (r.y6 ? d > r.y6 ? (f = r.x6 + (r.x5 - r.x6) / (r.y5 - r.y6) * (d - r.y6),
        ...
        x.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    ...
                    b = 0,
                    g = q; b < this.logLabelValues.length; b++)
                        ...
                        c < this.viewportMinimum)
                            ...
                            }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : da(n, this.valueFormatString, this.chart._cultureInfo),
                            a = new ia(this.ctx,{
                                x: 0,
                                y: 0,
                                maxWidth: f,
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? m : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                    n = (k - (l + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)),
                                    !s(this.options.labelWrap))
                                        this.labelWrap ? s(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n),
                                        this.sessionVariables.labelWrap = this.labelWrap,
                                        d && r.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                        ...
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth))
                                                ...
                                                if (b = r.width + d.width >> 0,
                                                g = this.labelFontSize,
                                                q < f)
                                                    b - 2 * f > p && (p = b - 2 * f,
                                                    b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f,
                                                    s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g),
                                                    a.measureText()),
                                                    ...
                                                    this.sessionVariables.labelFontSize = g) : b >= 2.8 * f && b < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, q),
                                                    ...
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelMaxWidth = n,
                                                    this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelAngle = -25,
                                                    this.sessionVariables.labelMaxWidth = n) : b > 5 * f && (this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelMaxWidth = f,
                                                    this.sessionVariables.labelFontSize = g,
                                                    this.sessionVariables.labelMaxHeight = m,
                                                    this.sessionVariables.labelAngle = this.labelAngle));
                                                else if (v === c && (0 === v && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p || v === this._labels.length - 1 && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p || 0 < v && v < this._labels.length - 1 && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p))
                                                    ...
                                                    for (this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    b = 0; b < this._labels.length; b++)
                                                        a = this._labels[b].textBlock,
                                                        a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n),
                                                        r = a.measureText(),
                                                        b < this._labels.length - 1 && (g = b + 1,
                                                        d = this._labels[g].textBlock,
                    ...
                    !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                                Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                                s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? s(this.options.labelWrap) ? s(this.options.labelWrap) && (s(this.options.labelMaxWidth) ? s(d) || (h = r.height + d.height >> 0,
                                h - 2 * m > q && (q = h - 2 * m,
                                h >= 2 * m && h < 2.4 * m ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelMaxHeight = m,
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : h >= 2.4 * m && h < 2.8 * m ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelFontSize = this.labelFontSize,
                                this.sessionVariables.labelWrap = !0) : h >= 2.8 * m && h < 3.2 * m ? (this.sessionVariables.labelMaxHeight = m,
                                this.sessionVariables.labelWrap = !0,
                                s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h >= 3.2 * m && h < 3.6 * m ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelWrap = !0,
                                this.sessionVariables.labelFontSize = this.labelFontSize) : h > 3.6 * m && h < 10 * m ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelMaxHeight = m,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h > 10 * m && h < 50 * m && (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxHeight = m,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = m,
                                ...
                                s(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? m : b,
                                this.sessionVariables.labelWrap = this.labelWrap,
                                this.sessionVariables.labelMaxWidth = f) : (this.sessionVariables.labelMaxHeight = m,
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position)
                        s(f.options.labelWrap) && !s(this.sessionVariables.stripLineLabelMaxHeight) ? x = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = x = f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position)
                        s(f.options.labelWrap) && !s(this.sessionVariables.stripLineLabelMaxHeight) ? x = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = x = f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var r = q[g].scaleBreaks._appliedBreaks, v = 0; v < r.length && !(r[v].startValue > q[g].viewportMaximum); v++)
                        r[v].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = v),
            ...
            if ("normal" === e) {
                for (var x = [], z = [], A = [], y = [], M = [], N = [], O = [], Q = []; 4 > v; ) {
                    ...
                    if (c && 0 < c.length)
                        for (A = [],
                        g = P = 0; g < c.length; g++)
                            A.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)),
                            P += A[g],
                    ...
                    if (b && 0 < b.length)
                        for (y = [],
                        g = $ = 0; g < b.length; g++)
                            y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)),
                            $ += y[g],
                            Z += b[g] ? b[g].margin : 0;
                    else
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            a[g] && (a[g].lineCoordinates.x1 = m,
                            l = Math.round(f.x2 - $ - Z > n.width - p ? n.width - p : f.x2 - $ - Z),
                            a[g]._labels && 1 < a[g]._labels.length && (h = k = 0,
                            k = a[g]._labels[1],
                            ...
                            !a[g] || (!a[g].labelAutoFit || s(D) || s(E) || n.isNavigator || n.stockChart) || (h = 0,
                            0 < a[g].labelAngle ? E + t > l && (h += 0 < a[g].labelAngle ? E + t - l - $ : 0) : 0 > a[g].labelAngle ? D - w < m && D - w < a[g].viewportMinimum && (F = m - (K + a[g].tickLength + A + D - w + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (E + t > l && (h = E + t / 2 - l - $),
                            D - w < m && D - w < a[g].viewportMinimum && (F = m - K - a[g].tickLength - A - D + w / 2)),
                            a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h ? l -= h : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < F ? m += F : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < F && (m += F),
                            0 < h && (l -= h))),
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            ...
                            d[g].lineCoordinates.width = Math.abs(l - m),
                            d[g]._labels && 1 < d[g]._labels.length && (k = d[g]._labels[1],
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            ...
                            c[g] && (m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                            ...
                            "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (A[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] && (m = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2),
                            l = Math.round(m),
                            ...
                            "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (y[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2,
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            a[g] && (a[g].calculateValueToPixelConversionParameters(),
                            a[g].calculateBreaksSizeInValues(),
                            a[g]._labels && 1 < a[g]._labels.length && (D = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1,
                            m = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position,
                            m = a[g].getApparentDifference(a[g].viewportMinimum, m),
                            E = a[g].logarithmic ? (1 < m ? Math.log(m) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < m ? m * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            d[g].calculateValueToPixelConversionParameters(),
                            d[g].calculateBreaksSizeInValues(),
                            d[g]._labels && 1 < d[g]._labels.length && (D = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1,
                            m = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position,
                            m = d[g].getApparentDifference(d[g].viewportMinimum, m),
                            E = d[g].logarithmic ? (1 < m ? Math.log(m) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < m ? m * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                    for (g = 0; g < q.length; g++)
                        "axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(),
                ...
                for (N = []; 4 > v; ) {
                    ...
                    if (d && 0 < d.length)
                        for (w = [],
                        g = T = 0; g < d.length; g++)
                            w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)),
                            T += w[g],
                            W += d[g] ? d[g].margin : 0;
                    else
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            ...
                            c[g].labelAutoFit && !s(x) && (0 < !a.length && (m = 0 > c[g].labelAngle ? Math.max(m, x) : 0 === c[g].labelAngle ? Math.max(m, x / 2) : m),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            ...
                            b[g] && b[g].labelAutoFit && !s(A) && (0 < !a.length && (m = 0 < b[g].labelAngle ? Math.max(m, A) : 0 === b[g].labelAngle ? Math.max(m, A / 2) : m),
                            0 < !d.length && (l -= y / 2)),
                    ...
                    if (b && 0 < b.length)
                        for (D = [],
                        g = V = 0; g < b.length; g++)
                            D.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)),
                            V += D[g],
                            Z += b[g].margin;
                    else
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            0 < c[g]._labels.length && (k = c[g]._labels[0],
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0],
                    ...
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            ...
                            "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0),
                        ...
                        for (g = 0; g < a.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (l = 0 > c[K].labelAngle ? Math.max(l, x) : 0 === c[K].labelAngle ? Math.max(l, x / 2) : l,
                                    m = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? l - U : m);
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && (l = b[K].lineCoordinates.x1,
                                    m = l - U);
                            a[g].lineCoordinates = {
                                x1: l - O,
                                y1: h,
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (l = 0 > c[K].labelAngle ? Math.max(l, x) : 0 === c[K].labelAngle ? Math.max(l, x / 2) : l,
                                    m = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? l - T : m);
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && (l = b[K].lineCoordinates.x2,
                                    m = l - T);
                            d[g].lineCoordinates = {
                                x1: l + Q,
                                y1: h,
        ...
        x.prototype.renderLabelsTicksAndTitle = function() {
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, m, h = this.viewportMaximum, l = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            ...
                            if (p.position < this.viewportMinimum)
                                break;
                            p.position > this.viewportMaximum || !(k === this._labels.length - 1 || m < Math.log(h / p.position) * l / e) || (c.push(p),
                            h = p.position,
                            m = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (k = 0; k < this._labels.length; k++)
                            p = this._labels[k],
                            p.position < this.viewportMinimum || (m = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            c += m);
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], n, h = this.viewportMaximum, l = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            ...
                            if (p.position < this.viewportMinimum)
                                break;
                            p.position > this.viewportMaximum || !(k === this._labels.length - 1 || n < Math.log(h / p.position) * l) || (c.push(p),
                            h = p.position,
                            n = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (k = 0; k < this._labels.length; k++)
                            p = this._labels[k],
                            p.position < this.viewportMinimum || (n = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            b += n);
            ...
            if ("bottom" === this._position) {
                for (k = 0; k < this._labels.length; k++)
                    p = this._labels[k],
                    p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position),
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === p.textBlock.angle ? (q.x -= p.textBlock.width / 2,
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (k = 0; k < a._labels.length; k++)
                        if (p = a._labels[k],
                        !(p.position < a.viewportMinimum || p.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(p.position),
                        a.tickThickness)) {
                ...
                for (k = 0; k < this._labels.length; k++)
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (p.textBlock.y = q.y,
            ...
            if ("inside" === this.labelPlacement)
                this.chart.addEventListener("dataAnimationEnd", function() {
                    for (k = 0; k < a._labels.length; k++)
                        p = a._labels[k],
                        p.position < a.viewportMinimum || (p.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(),
                        a.ctx.beginPath(),
                    ...
                    !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                        ...
                        if ("outside" === c.stripLine.labelPlacement)
                            ...
                            "bottom" === this._position) {
                                ...
                                a.y += this.tickLength + c.textBlock.fontSize / 2 + 5) : (a.x -= 0 > this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0,
                                ...
                                this.ctx.stroke(),
                                0 === this.labelAngle ? (a.x -= c.textBlock.width / 2,
                                a.y -= this.tickLength + c.textBlock.height - c.textBlock.fontSize / 2) : (a.x += (c.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                                a.y -= this.tickLength + (c.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))) : "left" === this._position ? (n = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
                                this.ctx.beginPath(),
                            ...
                            a.x - c.textBlock.height > this.chart.plotArea.x1 ? s(k.startValue) ? a.x -= c.textBlock.height - c.textBlock.fontSize / 2 : a.x -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3 : (c.textBlock.angle = 90,
        ...
        x.prototype.createMask = function() {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                w ? (this.maskCanvas = ra(this.chart.width, this.chart.height),
        ...
        x.prototype.renderAxisLine = function() {
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex))
                            ...
                            for (var h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++)
                                d.moveTo(e, m),
                                d.lineTo(this.scaleBreaks._appliedBreaks[h].startPixel + c, m),
            ...
            w && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height),
        ...
        x.prototype.calculateAxisParameters = function() {
            if (this.logarithmic)
                ...
                if ("axisX" === this.type) {
                    ...
                    f += b,
                    e -= b);
                    Infinity !== this.dataInfo.minDiff ? h = this.dataInfo.minDiff : 1 < f - e ? h = 0.5 * Math.abs(f - e) : (h = 1,
                    c && (d = !0))
                } else
                ...
                if ("axisX" === this.type && c) {
                    ...
                    this.intervalType = "month") : (this.interval = b / (1 * S.yearDuration) <= a ? 1 : b / (2 * S.yearDuration) <= a ? 2 : b / (4 * S.yearDuration) <= a ? 4 : Math.floor(x.getNiceNumber(b / (a - 1), !0) / S.yearDuration),
                ...
                if (null === this.minimum || null === this.maximum)
                    ...
                    f += b,
                    e -= b),
                    h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min,
                    f = null !== this.maximum ? this.maximum : this.dataInfo.max,
                    ...
                    "axisX" === this.type && c) {
                        ...
                        this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
                        null === this.maximum && (this.maximum = "axisX" === this.type ? f + h / 2 : Math.ceil(f / this.interval) * this.interval,
                        this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)),
        ...
        x.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = x.getNiceExponent(Math.log(h) / d / (a - 1), !0),
            ...
            this.options && "undefined" === typeof this.options.interval && (this.interval = x.getNiceExponent(Math.ceil(Math.log(h) / d) / (a - 1)),
            c = x.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
            if (null === this.minimum || null === this.maximum)
                ...
                s(null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? "undefined" === typeof this.sessionVariables.newViewportMaximum ? 0 : this.sessionVariables.newViewportMaximum : this.sessionVariables.viewportMaximum) || (this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? "undefined" === typeof this.sessionVariables.newViewportMaximum ? 0 : this.sessionVariables.newViewportMaximum : this.sessionVariables.viewportMaximum))),
        ...
        X.prototype.createUserOptions = function(a) {
            if ("undefined" !== typeof a || this.options._isPlaceholder) {
                ...
                this.options._isPlaceholder || (Ba(this.parent[this.optionsName]),
        ...
        X.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0,
                    h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0,
                    "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1,
                    l = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2,
        ...
        O.prototype.createUserOptions = function(a) {
            if ("undefined" !== typeof a || this.options._isPlaceholder) {
                var d = 0;
                this.parent.options._isPlaceholder && this.parent.createUserOptions();
                this.options._isPlaceholder || (Ba(this.parent.stripLines),
        ...
        ca.prototype.showAt = function(a) {
            ...
            for (b = 0; b < d.axisY2.length; b++)
                ...
                d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !s(a) && a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a),
        ...
        ca.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var w = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position)
                        r = this.parent.dataSeries[0].axisX.convertPixelToValue({
                            y: d
                        });
                    else if ("left" === this.parent._position || "right" === this.parent._position)
                    ...
                    for (var y = 0; y < this.parent.dataSeries.length; y++)
                        (w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= w.index && (w.dataSeries = this.parent.dataSeries[y],
                        ...
                        for (var w = Math.abs(a - this.parent.convertValueToPixel(n[y].dataPoint.y[0])), t = 0, r = 0; r < n.length; r++)
                            if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                                for (var B = 0; B < n[r].dataPoint.y.length; B++)
                                    t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[B])),
                                    t < w && (w = t,
                                    y = r);
                            else
                                t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y)),
                                t < w && (w = t,
                                y = r);
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            for (r = t = 0; r < B.dataPoint.y.length; r++)
                                t = Math.abs(a - this.parent.convertValueToPixel(B.dataPoint.y[r])),
                                t < w && (w = t,
                                b = r);
                            ...
                            }) : s(this.options.label) ? da(s(c) ? B.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                        ...
                        if (A) {
                            if ("axisX" === this.parent.type)
                                ...
                                w = null,
                                y = 0; y < this.parent.dataSeries.length; y++)
                                    (w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= w.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                        chart: this.chart,
                                        axis: this.parent.options,
                                        crosshair: this.options,
                                        value: B.dataPoint.x
                            ...
                            "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: B.dataPoint.x
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type)
                        for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])),
                        r = t = 0; r < n.length; r++)
                            if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                                for (B = 0; B < n[r].dataPoint.y.length; B++)
                                    t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[B])),
                                    t < w && (w = t,
                                    y = r);
                            else
                                t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y)),
                                t < w && (w = t,
                                y = r);
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                        ...
                        for (r = t = 0; r < B.dataPoint.y.length; r++)
                            t = Math.abs(d - this.parent.convertValueToPixel(B.dataPoint.y[r])),
                            t < w && (w = t,
                            b = r);
                        ...
                        "waterfall" === this.parent.dataSeries[y].type ? (v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(B.dataSeries.dataPointEOs[B.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(B.dataSeries.dataPointEOs[B.index].cumulativeSum) << 0,
                        k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: B.dataSeries.dataPointEOs[B.index].cumulativeSum
                        }) : s(this.options.label) ? da(s(c) ? B.dataSeries.dataPointEOs[B.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                        this.value = B.dataSeries.dataPointEOs[B.index].cumulativeSum) : (v = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(B.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(B.dataPoint.y) << 0,
                        k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                ...
                if ("left" === this.parent._position || "right" === this.parent._position)
                    ...
                    h >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < p && (q.moveTo(b, f),
                    q.lineTo(e, h),
                    q.stroke(),
                    this._hidden = !1),
                    q.restore())
                    ...
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: s(c) ? this.parent.convertPixelToValue(a) : c
                            }) : s(this.options.label) ? da(s(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                            k.x = b - k.measureText().width / 2,
                            k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width),
                            k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1),
                            "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
        ...
        Z.prototype._updateToolTip = function(a, d, c) {
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var v = 0; v < this.chart.axisX.length; v++) {
                            for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[v].convertPixelToValue({
                                ...
                                (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b],
                    ...
                    if (this.chart.axisX2)
                        for (v = 0; v < this.chart.axisX2.length; v++) {
                            ...
                            for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                                (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b],
                                null !== k.dataPoint.y && k.dataSeries.visible && l.push(k));
                            k = null
                        }
                    if (0 === l.length)
                    ...
                    c = l[0];
                    for (b = 0; b < l.length; b++)
                        l[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() && f.push(l[b]);
                    l = null
                } else {
                    if (b = this.chart.getDataPointAtXY(a, d, c))
                        ...
                        if (b = Ya(a, d, this.chart._eventManager.ghostCtx),
                        ...
                        if (!s(k) && !s(k.dataPoint) && !s(k.dataPoint.y))
                            if (k.dataSeries.axisY)
                                if (0 < k.dataPoint.y.length) {
                                    ...
                                    "column" === e.type || "bar" === e.type ? 0 > k.dataPoint.y ? 0 > k.dataSeries.axisY.viewportMinimum && k.dataSeries.axisY.viewportMaximum >= k.dataPoint.y && f.push(k) : k.dataSeries.axisY.viewportMinimum <= k.dataPoint.y && 0 <= k.dataSeries.axisY.viewportMaximum && f.push(k) : "bubble" === e.type ? (c = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size / 2,
                                    ...
                                    2 > c && -2 < c && f.push(k)) : (0 <= k.dataSeries.type.indexOf("100") || "stackedColumn" === e.type || "stackedBar" === e.type || k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum) && f.push(k);
                            else
                                f.push(k)
                    }
                }
                if (0 < f.length) {
                    if (this.highlightObjects(f),
                    this.enabled) {
                        c = "";
        ...
        Z.prototype.highlightObjects = function(a) {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    $.drawMarkers([f]),
                    "undefined" !== typeof e.y2 && (f = b.getMarkerProperties(h, e.x1, e.y2, this.chart.overlaidCanvasCtx),
                    f.size = Math.max(1.5 * f.size << 0, 10),
                    f.borderColor = f.borderColor || "#FFFFFF",
                    f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size),
                    $.drawMarkers([f]))) : "bubble" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                    f.size = e.size,
                    f.color = "white",
                    f.borderColor = "white",
                    d.globalAlpha = 0.3,
                    $.drawMarkers([f]),
                    d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ea(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? ha(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? na(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1,
                    ...
                    d.stroke()),
                    d.restore(),
                    d.globalAlpha = 1) : "error" === b.type && y(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        Z.prototype.getToolTipInnerHTML = function(a) {
            ...
            if (this.isToolTipDefinedInData && (this.content && "function" === typeof this.content || this.contentFormatter))
                ...
                for (var l = null, s = "", h = 0; h < a.length; h++) {
                    ...
                    null === b.toolTipContent || "undefined" === typeof b.toolTipContent && null === c.options.toolTipContent || ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "waterfall" === c.type ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += l != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                    f += b.toolTipContent ? b.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span data-color='\"" + (this.options.fontColor ? "" : "'{color}'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}",
                    l = c.axisXIndex) : "bubble" === c.type ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += l != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                    ...
                    f += b.toolTipContent ? b.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span data-color='\"" + (this.options.fontColor ? "" : "'{color}'") + "\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}") : "boxAndWhisker" === c.type && (this.chart.axisX && 1 < this.chart.axisX.length && (f += l != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                    ...
                    null === d && (d = ""),
                    c.visible && (!0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d,
                    h < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, b, c, e),
                    h < a.length - 1 && (d += "</br>"))))
                }
                null !== d && (d = s + d)
            } else {
        ...
        ga.prototype.reset = function() {
            ...
            this.previousDataPointEventObject = null;
            this.eventObjects = [];
            w && (this.ghostCtx.clearRect(0, 0, this.chart.width, this.chart.height),
            this.ghostCtx.beginPath())
        }
        ;
